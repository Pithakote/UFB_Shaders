...
public class ToonURPShaderTransparentGUI : ShaderGUI//is being included in ToonURPShader.shader
{
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        */
        ...
        MaterialProperty _alphaProperty = ShaderGUI.FindProperty("_Alpha", properties);
        ...
        materialEditor.ShaderProperty(_alphaProperty, _alphaProperty.displayName);
